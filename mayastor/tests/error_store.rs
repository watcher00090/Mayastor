// pub mod common;
// use mayastor::{
//     bdev::{nexus_io::IoStatus, NexusErrStore, QueryType},
//     core::io_driver::IoType,
// };
...
//     assert_eq!(errors, 0);
//
//     errors = es.query(ALL_FLAGS, ALL_FLAGS, None, QueryType::Total); // no
// time specified     assert_eq!(errors, 15);
//
//     /////////////////////// filter by op ////////////////////////
//     errors = do_query(&es, NexusErrStore::READ_FLAG, ALL_FLAGS, start_inst,
// 10);     assert_eq!(errors, 1);
//
//     errors =
